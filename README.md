...
**Project Outline**
  ...
  - **Approach**
    - **Ideas**
      ...
      - training data is generated by an algorithm whose input is average speech from a dataset (e.g. VoxCeleb) and whose output is labelled with a number indicating probability of anxiety and a modified speech sample that embeds certain auditory cues
  - **Competitors**:
 ...
 **Ordered TODO**
 - **Project**
  ...
  2. implement synthetic data generation model (given the associations between certain acoustic cues/heart rate and anxiety)
 - **Competition**
