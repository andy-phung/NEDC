...
**Project Outline**
  ...
  - **Approach**
    - **Ideas**
      ...
      - training data is generated by a model whose input is average speech from a dataset (e.g. VoxCeleb) and whose output is labelled with a number indicating probability of anxiety and a modified speech sample that embeds certain auditory cues
  - **Competitors**:
